  ...
  return (
    <Layout title="Services">
      <div style={{ padding: '20px', maxWidth: '830px', margin: '0 auto', color: '#F5F5F5' }}>
        <h1 style={{ color: '#F5F5F5' }}>Payment Services</h1>
...
<h3>🌍  Stablecoin Strategy</h3>

<p>
<img src="static/img/usdc.jpg" alt="USDC" style="width:150px; float:right; margin-left:15px;">
...
<h3>
📊 Connected Dashboards & Data Sync
</h3>
<p>
